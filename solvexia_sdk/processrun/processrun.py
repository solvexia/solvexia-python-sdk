...
class processruns:
    ...
    def getProcessRun(self):
        ...
        helper.statusCodeCheck(response.status_code, "Error getting the specified process run")
    ...
    def startProcessRun(self):
        ...
        helper.statusCodeCheck(response.status_code, "Error starting process run")
        return response.json()
    ...
    def cancelProcessRun(self):
        ...
        helper.statusCodeCheck(response.status_code, "Error cancelling process run")
        return response.json()
    ...
    def processStatus(self):
        ...
        helper.statusCodeCheck(response.status_code, "Error getting run status of a process run")
        return response.json()
    ...
    def processRunDataSteps(self):
        ...
        helper.statusCodeCheck(response.status_code, "Error getting list of data steps")
        return response.json()
